...
project = "mean_shift_project"
copyright = "2025, Alanopea"
...
try:
    from mean_shift_project import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "mean_shift_project-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "mean_shift_project Documentation", "Alanopea", "manual")
]
